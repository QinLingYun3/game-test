...
const translations = {
  zh: {
    ...
    "game.timeLeftLabel": "剩余时间",
    "game.reshuffleCountdown": "洗牌倒计时 {{count}}",
    "game.soloReshuffling": "洗牌中",
    "game.soloPauseButton": "暂停",
    "game.soloPausePrompt": "你已暂停游戏 {{time}}",
    "game.soloResume": "继续",
    ...
    "beta.consent": "我同意这是先行版，得分和记录可能随时被重置",
    ...
    "error.betaConsentRequired": "必须同意才能开始游戏",
    ...
    "item.quickMatchDesc": "快速消除：双击立即消除一对 tile，时间 -4 秒。",
    "item.reshuffle": "洗牌",
    "item.reshuffleDesc": "洗牌：重新排列棋盘上剩余牌的位置，时间 -4 秒。",
  ...
  en: {
    ...
    "game.timeLeftLabel": "Time Left",
    "game.reshuffleCountdown": "Reshuffle in {{count}}",
    "game.soloReshuffling": "Reshuffling",
    "game.soloPauseButton": "Pause",
    "game.soloPausePrompt": "Game paused {{time}}",
    "game.soloResume": "Resume",
    "game.comboPopup": "{{count}} Combo!",
    ...
    "beta.consent": "I agree this is a beta version, scores and records may be reset at any time",
    ...
    "error.betaConsentRequired": "You must agree to proceed",
    ...
    "item.quickMatchDesc": "Quick Match: double-click to remove one pair instantly. Time -4s.",
    "item.reshuffle": "Reshuffle",
    "item.reshuffleDesc": "Reshuffle: rearrange the remaining tiles on the board. Time -4s.",
  ...
  fr: {
    ...
    "game.timeLeftLabel": "Temps restant",
    "game.reshuffleCountdown": "Melange dans {{count}}",
    "game.soloReshuffling": "Melange en cours",
    "game.soloPauseButton": "Pause",
    "game.soloPausePrompt": "Jeu en pause {{time}}",
    "game.soloResume": "Reprendre",
    "game.comboPopup": "{{count}} Combo !",
    ...
    "results.backToHome": "Retour a l'accueil",
    ...
    "beta.consent": "J'accepte qu'il s'agit d'une version beta, les scores peuvent etre reinitialises a tout moment",
    ...
    "server.playerLeft": "Un joueur est parti. La salle est revenue au hall",
    "error.enterNickname": "Veuillez entrer un pseudo",
    "error.betaConsentRequired": "Vous devez accepter pour continuer",
    ...
    "item.quickMatchDesc": "Coup rapide : double-clic pour eliminer une paire instantanement. Temps -4s.",
    "item.reshuffle": "Melanger",
    "item.reshuffleDesc": "Melanger : reorganiser les tuiles restantes sur le plateau. Temps -4s.",
