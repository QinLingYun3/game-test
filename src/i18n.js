...
const translations = {
  zh: {
    ...
    "item.reshuffle": "洗牌",
    "item.reshuffleDesc": "洗牌：重新排列棋盘上剩余牌的位置，洗牌期间倒计时暂停。",
  ...
  en: {
    ...
    "item.reshuffleDesc": "Reshuffle: rearrange the remaining tiles on the board. Countdown pauses during reshuffle.",
  ...
  fr: {
    ...
    "item.reshuffleDesc": "Melanger : reorganiser les tuiles restantes sur le plateau. Le compte a rebours se met en pause pendant le melange.",
